            ...
            children: [
              Expanded(
                child: MaterialButton(
                  ...
                  child:
                      Text("Save".tr, style: Get.textTheme.bodyText2.merge(TextStyle(color: Get.theme.primaryColor))),
                  elevation: 0,
        ...
        body: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              Text("Change the following details and save them".tr, style: Get.textTheme.caption)
              ...
              Obx(() {
                ...
                return TextFieldWidget(
                  ...
                  validator: (input) =>
                      input.length > 0 && input.length < 3 ? "Should be more than 3 letters".tr : null,
                  ...
                  suffixIcon: IconButton(
                    ...
                    icon:
                        Icon(controller.hidePassword.value ? Icons.visibility_outlined : Icons.visibility_off_outlined),
                  ),
                  isFirst: true,
                  isLast: false,
                );
