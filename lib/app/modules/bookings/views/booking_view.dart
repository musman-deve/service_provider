                  ...
                  Obx(() {
                    if (controller.booking.value.address == null)
                      ...
                      return MaterialButton(
                        elevation: 0,
                        onPressed: () => MapsUtil.openMapsSheet(
                            context, controller.booking.value.address?.getLatLng(), controller.booking.value.id),
                ...
                flexibleSpace: Obx(() {
                  if (controller.booking.value.address == null)
                    ...
                    return FlexibleSpaceBar(
                      ...
                      background: MapsUtil.getStaticMaps([controller.booking.value.address.getLatLng()],
                              ...
                              children: [
                                if (controller.booking.value.bookingAt != null)
                                  BookingRowWidget(
                                      ...
                                      hasDivider: controller.booking.value.startAt != null ||
                                          controller.booking.value.endsAt != null),
                                if (controller.booking.value.startAt != null)
                                  BookingRowWidget(
                                      ...
                                      child: Align(
                                          ...
                                          child: Text(
                                            DateFormat('d, MMMM y  HH:mm', Get.locale.toString())
                                                .format(controller.booking.value.startAt),
                                            style: Get.textTheme.caption,
                                            textAlign: TextAlign.end,
                                          )),
                                      hasDivider: false),
                                if (controller.booking.value.endsAt != null)
                                  BookingRowWidget(
                                    ...
                                    child: Align(
                                        ...
                                        child: Text(
                                          DateFormat('d, MMMM y  HH:mm', Get.locale.toString())
                                              .format(controller.booking.value.endsAt),
                                          style: Get.textTheme.caption,
                                          textAlign: TextAlign.end,
                                        )),
                                  ),
                          ...
                          content: Column(
                            children: [
                              BookingRowWidget(
                                  ...
                                  child: Align(
                                    alignment: Alignment.centerRight,
                                    child: Ui.getPrice(controller.booking.value.eService.getPrice,
                              ...
                              Obx(() {
                                return BookingRowWidget(
                                  ...
                                  child: Align(
                                    alignment: Alignment.centerRight,
                                    child: Ui.getPrice(controller.booking.value.getTotal(),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Expanded(
                        child: AutoSizeText(_booking.value.address?.address ?? '',
                            maxLines: 2, overflow: TextOverflow.ellipsis, style: Get.textTheme.bodyText1),
                      ),
                    ],
                    // spacing: 8,
                    // crossAxisAlignment: WrapCrossAlignment.center,
