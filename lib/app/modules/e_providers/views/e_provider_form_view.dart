          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text("Fill the following details and save them".tr, style: Get.textTheme.caption)
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              MaterialButton(
                                onPressed: () async {
                                  final selectedValue = await showDialog<EProviderType>(
                                    context: context,
                                    builder: (BuildContext context) {
                                      return SelectDialog(
                                        ...
                                        initialSelectedValue: controller.eProviderTypes.firstWhere(
                                          (element) => element.id == controller.eProvider.value.type?.id,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                                        ...
                                        .where(
                                          (tax) =>
                                              controller.eProvider.value.taxes
                                                  ?.where((element) => element.id == tax.id)
                                                  ?.isNotEmpty ??
                                              false,
                                        )
                                        .toSet(),
                      ...
                      Obx(() {
                        if (controller.eProvider.value?.taxes?.isEmpty ?? true) {
                          return Padding(
                            padding: EdgeInsets.symmetric(vertical: 20),
                            child: Text(
                              "Select Taxes".tr,
