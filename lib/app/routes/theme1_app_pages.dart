...
import '../modules/auth/views/otp_verification.dart';
import '../modules/auth/views/phone_verification_view.dart';
import '../modules/auth/views/register_view.dart';
import '../modules/auth/views/registration_review.dart';
import '../modules/auth/views/selection.dart';
import '../modules/auth/views/service_provider/freelance_service.dart';
import '../modules/auth/views/user_address.dart';
import '../modules/auth/views/user_information.dart';
...
class Theme1AppPages {
  ...
  static final INTRO = Get.find<AuthService>().user.value.isProvider ? Routes.ROOT : Routes.INTRO;
  ...
  static final routes = [
    ...
    GetPage(name: Routes.REGISTER, page: () => UserInformation(), binding: AuthBinding()),
    GetPage(name: Routes.FORGOT_PASSWORD, page: () => ForgotPasswordView(), binding: AuthBinding()),
    GetPage(name: Routes.OTP_VERIFICATION, page: () => OtpVerification(), binding: AuthBinding()),
    GetPage(name: Routes.ADDRESS, page: () => UserAddress(), binding: AuthBinding()),
    GetPage(name: Routes.REGISTRATION_REVIEW, page: () => RegistrationReview(), binding: AuthBinding()),
    GetPage(name: Routes.BECOME_PROVIDER, page: () => FreelanceService(), binding: AuthBinding()),
    GetPage(
